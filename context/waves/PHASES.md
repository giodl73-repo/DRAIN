...
| `2026-06-26-drain-implementation` | planned | Build WP-001..006 bottom-up, one work package per pulse (pulses 01–06). No code until executed. |

## Active wave

- `2026-06-26-drain-implementation` (all pulses defined; pending execution)
