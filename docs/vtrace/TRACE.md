...
VTRACE adoption scope: connect DRAIN's accepted requirements to mission needs, CONOPS scenarios,
controlled specification items, future design surfaces, work packages, verification, validation,
and evidence. DRAIN is greenfield: design elements, work packages, and evidence are
...
| REQ-004 | NEED-004 / CON-002 / OPS-001 | SPEC-001 | wastewater/sewer kernel (`drain-network`) | deferred → IMPL_PLAN | VER-004 / schema check | OPS-001 | future EVID-004 | accepted |
...
| REQ-007 | NEED-002 / CON-001 / OPS-003 / OPS-006 | SPEC-005 / SPEC-WW-01 / SPEC-DW-01 | scoring + tier (demand basis) | deferred → IMPL_PLAN | VER-007 / analysis / inspection | OPS-003 | future EVID-007 | accepted |
...
| DEF-002 | Observed utility records vs permit/ECHO/CWNS proxy capacity and overflow modelling. | `SPECIFICATION_BASELINE` (SPEC-WW-02 / SPEC-DW-02) | deferred |
...
| SPEC-UNK-002 | permit/ECHO/CWNS proxy vs observed utility data for DIM-02/03. | operations reviewer | accept risk (proxy) |
| SPEC-UNK-003 | Benefit-cost basis for DIM-12. | wastewater economist | defer to calibration |
| SPEC-UNK-004 | Per-tier SLA thresholds (DIM-13). | DRAIN maintainer | defer to calibration |
| SPEC-UNK-005 | Scale nesting representation. | DRAIN maintainer | defer (DEF-005) |
...
| Wastewater-System Planner | NEED-007/008 trace cleanly to REQ-014/015/016 and SPEC-011/012/013. | pass |
